...
| Project | Formal work unit with defined products, quality criteria, closure process. Global scope (base concept). | When performing formal work requiring structure, validation, and lessons capture | projects/04-bare-runtime-hello-world/Project_requirements_v1.3.0.md | See Exploration Project, Template-Based Project for types |

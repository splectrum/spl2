...
| dsl glossary | Splectrum vocabulary for horizontal meaning consistency. Entry structure: Term, Category (native/foreign/dialect), Description (horizontal meaning), Req. Primary audience: AI | projects/11-app-architecture/reqs/dsl_glossary_v2.0.0.md |
...
| meandering | Productive exploration through discussion; what appears as tangent is valuable discovery. Letting conversation explore surfaces better designs that efficient direct paths would miss. The friction is productive friction | projects/11-app-architecture/reqs/meandering_v1.0.0.md |
...
| plain req | Base req type using natural language for spec and self-eval. Structure: Type, Extends (optional), Version, Spec, Self-eval, Comments (optional), Models (optional). All req types extend this | projects/11-app-architecture/reqs/plain_req_v1.1.0.md |

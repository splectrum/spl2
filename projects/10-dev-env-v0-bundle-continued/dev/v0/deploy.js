...
if (workModuleName) {
  ...
  fs.cpSync(workModuleSrc, path.join(modulesDir, workModuleName), { recursive: true })
  console.log(`✓ Copied ${workModuleName}/ to modules/`)
}
...
const libSourceDir = workModuleName ? path.join(modulesDir, workModuleName, '_lib') : null
if (libSourceDir && fs.existsSync(libSourceDir)) {

...
- Create `reqs/` folder for project requirements
...
- [ ] Has required project artifacts (BRIEF, LOG, RISKS, reqs/)
...
v1.2.0: Added reqs/ folder to create phase - clean home for all reqs created/evolved during project.

v1.1.0: Added phases from PRINCE2_operational_v1.2.0.md.
